...
#pragma warning restore 414
    ...
    bool physicsActiveStateBeforePlaying = false;
    ...
    void Update()
    {
        ...
        if (EditorApplication.isPlaying && !justPlaying)
        {
            UnityEngine.Debug.Log("PLAYING");
            physicsActiveStateBeforePlaying = physicActive;
            physicActive = true;
            justPlaying = true;
        }
        if (!EditorApplication.isPlaying && justPlaying)
        {
            UnityEngine.Debug.Log("NOT PLAY");
            physicActive = physicsActiveStateBeforePlaying;
            justPlaying = false;
        }
    ...
    private void OnGUI()
    {
        ...
        physicActive = EditorGUILayout.ToggleLeft(new GUIContent("Is Physics Active", "Toggle the physics engine - this will not affect the objects (RIGHT CTRL)' rigidbodies"), physicActive, GUILayout.Width(150));
